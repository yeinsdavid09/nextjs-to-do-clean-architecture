...
//* Interfaces
import { LateralSlideProps } from "./lateral-slide.interfaces";
import { ButtonActions } from "../../ui/molecules/button/button.interfaces";

// --------------------------------- Type ---------------------------------

type LateralSlideState = {
  onDeployed: boolean;
  options: LateralSlideProps | null;
  content: ReactNode | null;
  action: ButtonActions;
  buttonEnable: boolean;
  open: (options: LateralSlideProps, content: ReactNode) => void;
...
export const useLateralSlideState = create<LateralSlideState>((set, get) => ({
  // --------------------------------- Variables ---------------------------------
